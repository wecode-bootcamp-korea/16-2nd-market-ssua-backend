    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grade', models.ForeignKey(default=6, on_delete=django.db.models.deletion.CASCADE, to='users.grade')),
            ],
            options={
                'db_table': 'users',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_dt', models.DateField()),
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.pointstatus')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.user')),
            ],
            options={
                'db_table': 'points',
